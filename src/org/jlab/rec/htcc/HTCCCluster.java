...
class HTCCCluster {
    ...
    HTCCCluster() {
        ...
        hitnphe = new ArrayList<>();
        hititheta = new ArrayList<>();
        hitiphi = new ArrayList<>();
        hittheta = new ArrayList<>();
        hitphi = new ArrayList<>();
        hitdtheta = new ArrayList<>();
        hitdphi = new ArrayList<>();
        hittime = new ArrayList<>();
        setitheta = new HashSet<>();
        setiphi = new HashSet<>();
    }
